...
##### Menu #######
sub menu {
    print item('01'),"Web sitesi bilgisi\n";
    print item('02'),"Telefon Numarası Bilgisi\n";
    print item('03'),"IP Adresi Ve E-posta Sunucusunu Bulun\n";
    print item('04'),"Domain Whois Araması\n";
    print item('05'),"Web Sitesi / IP Adresi Konumunu Bul\n";
    print item('06'),"CloudFlare'u atla\n";
    print item('07'),"Domain Age Checker\n";
    print item('08'),"Kullanıcı Temsilcisi Bilgisi\n";
    print item('09'),"Check Active Services On Resource\n";
    print item('10'),"Kredi Kartı Kutusu Denetleyicisi\n";
    print item('11'),"Subdomain Scanner\n";
    print item('12'),"Check E-mail Address\n";
    print item('13'),"Content Management System Checker\n";
    print item('14'),"Güncelleme\n";
    print item('-'),"Seç:\n";
    print color('reset');
